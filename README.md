...
# New Solution
## 1)Introduce Z, a latent 32-D (or more) variable. Each dimension follows the unit guassian - N(0,1) and represents a feature - noise, eye, height, color and hair (assuming we geneate human images).
...
# GAN - DCGAN, Deep Convolutional GAN
## Fix D, update G;
## Fix G, update D;
